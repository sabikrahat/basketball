...
function preload() {
    ...
    game.load.image('hoop', 'hoop.png');
		game.load.image('side rim', 'siderim.png');
		game.load.image('front rim', 'frontrim.png');
		...
		game.load.audio('score', 'score.wav');
		game.load.audio('backboard', 'backboard.wav');
		game.load.audio('whoosh', 'whoosh.wav');
		game.load.audio('fail', 'fail.wav');
		game.load.audio('spawn', 'spawn.wav');
